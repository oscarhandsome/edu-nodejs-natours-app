...
exports.signup = catchAsync(async (req, res, next) => {
  // const newUser = await User.create(req.body); // <--- serious security flaw (anyonve can specify role as admin for exacmple)
