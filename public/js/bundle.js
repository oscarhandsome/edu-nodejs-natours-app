...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib3NjYXJoYW5kc29tZSIsImEiOiJjbGZwMm50MzAxMjVyM3JwNnNxMm80Y3RhIn0.nTIKBXje9wn4IakxvQJFmw';
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51MrdrXGlGDCxkCpNlVQPP9Zr8yC4vRYhqSocEDRcrlNwoWvyu0fzpOtery1uIgcHmW0VytTzpehZHUeA0W8lNRaX00oAWSEyUU');
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
// DOM ELEMENTS
var mapNox = document.getElementById('map');
...
if (signUpForm) signUpForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var name, email, password, passwordConfirm, res, _i, _Object$keys, value;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
        ...
        case 8:
          ...
          if (res && res.error) {
            for (_i = 0, _Object$keys = Object.keys(res.error.errors); _i < _Object$keys.length; _i++) {
              ...
              document.getElementById(value).nextElementSibling.innerHTML = res.error.errors[value].message;
            }
            setTimeout(function () {
              for (var _i2 = 0, _Object$keys2 = Object.keys(res.error.errors); _i2 < _Object$keys2.length; _i2++) {
                var _value = _Object$keys2[_i2];
                document.getElementById(_value).classList.remove('form__input--error');
                document.getElementById(_value).nextElementSibling.innerHTML = '';
              }
            }, 5000);
          }
          _context.next = 16;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "8015" + '/');
